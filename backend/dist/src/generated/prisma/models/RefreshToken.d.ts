...
export type RefreshTokenOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"id" | "hashedToken" | "expiresAt" | "createdAt" | "deviceName" | "ipAddress" | "userAgent" | "userId", ExtArgs["result"]["refreshToken"]>;
