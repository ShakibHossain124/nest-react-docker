...
let RoleCheck = class RoleCheck {
    ...
    canActivate(context) {
        ...
        if (roles.includes(reqRole))
            return true;
        throw new common_1.ForbiddenException('Roles does not match');
    }
};
exports.RoleCheck = RoleCheck;
exports.RoleCheck = RoleCheck = __decorate([
    (0, common_1.Injectable)(),
    __metadata("design:paramtypes", [core_1.Reflector])
], RoleCheck);
//# sourceMappingURL=role-check.guard.js.map